...
public class MainActividad8 extends AppCompatActivity {
    ...
    private VersionAdapterSpinner adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Añadir al alumno
        datos.add(new Encapsulador(R.drawable.user, "Alumno: Bryan Morantes", "Desarrollador de la aplicación", false));

        // 3. Usar el adaptador nuevo (VersionAdapterSpinner) que no tiene RadioButton
        adapter = new VersionAdapterSpinner(this, datos);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                // Ya no necesitamos marcar/desmarcar porque no hay RadioButton
                // Simplemente actualizamos la descripción
                Encapsulador seleccionado = datos.get(position);
                textViewDescripcionLarga.setText(seleccionado.getDescripcion());
            }
