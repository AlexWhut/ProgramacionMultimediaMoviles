...
// Personalización: El texto de DONUTS incluye mi nombre.
public class Contenido {
    ...
    static {
        ponerEntrada(new Lista_entrada("0", R.drawable.ima1, "DONUTS", "El 15 de septiembre de 2009, fue lanzado el SDK de Android 1.6 Donut, basado en el núcleo Linux 2.6.29. En la actualización se incluyen numerosas características nuevas. (Personalizado por [Tu Nombre])"));
